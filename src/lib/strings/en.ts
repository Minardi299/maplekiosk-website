export const en = {
  meta: {
    ...
    demo: {
      ...
      desc: "15 minutes. Your menu, on a real kiosk.",
    },
    about: {
      title: "About — MapleKiosk",
      desc: "Founded in Longueuil. We build it and install it ourselves.",
    },
    salons: {
    ...
    restaurants: {
      ...
      desc: "Kiosk and kitchen screen for restaurants and takeout counters — delivery in one queue.",
    },
  ...
  hero: {
    ...
    ctaSecondary: "15 minutes, Tuesday at 2 p.m.",
    ticket: {
  ...
  calc: {
    ...
    disclaimer:
      "Published rates for Square (2.5% credit; 0.75% + 7¢ debit). Clover publishes no Canadian rates — we estimate with its published US in-person rate (2.3% + 10¢). “Your own acquirer” = a typical interchange-plus deal for a small merchant (1.3–1.8% on credit; 8¢ per debit transaction; about $60/month in fixed fees included). Estimates only — bring a statement for the real math.",
  ...
  finalCta: {
    title: "Founded in Longueuil. No contract. We install it ourselves.",
  ...
  features: {
    ...
    timelineTitle: "A morning at the counter",
    timeline: [
      {
        time: "7:00",
        text: "Open. The TVs and the kiosk light up with today's menu.",
      },
      {
        time: "8:15",
        text: "The rush. The kiosk takes the custom orders, the counter keeps ringing, the bar reads one queue.",
      },
      {
        time: "11:30",
        text: "Order-ahead and delivery land in the same queue as the counter.",
      },
      {
        time: "14:00",
        text: "Slow hour. Mark items sold out on every screen in one tap.",
      },
      {
        time: "20:00",
        text: "Close. The day's numbers are on one screen.",
      },
    ],
  },
  ...
  demo: {
    ...
    form: {
      ...
      phone: "Phone (texting is fine)",
      slot: "Preferred time",
      submit: "Book my 15 minutes",
    },
    orText: "Or text ",
    orEmail: "Or write to ",
    photo: "[PHOTO — founder at a counter]",
  },
  ...
  notFound: {
    ...
    text: "Head back home — or better, book the 15 minutes.",
    back: "Back to home",
  },
}
